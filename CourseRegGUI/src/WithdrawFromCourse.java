...
public class WithdrawFromCourse extends JFrame {
    ...
    public WithdrawFromCourse(CRS crs) {
        ...
        JLabel lblAddACourse = new JLabel("Withdraw Course");
        ...
        JButton btnEditACourse = new JButton("Withdraw from Course");
    ...
    public void delete(int val) {
        Student s = (Student)crs.getLoggedIn();
        ArrayList<Course> courses = s.getCourses();
        Course c = courses.get(val);
        c.decrementRegNumStud();
        c.withdrawStudent(s);
        courses.remove(val);
    }
