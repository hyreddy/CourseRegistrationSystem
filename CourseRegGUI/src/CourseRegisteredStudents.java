...
public class CourseRegisteredStudents extends JFrame {
    ...
    public CourseRegisteredStudents(CRS crs) {
        ...
        JLabel lblAddACourse = new JLabel("View Enrolled Students");
        ...
        myList.setBounds(60, 120, 400, 600);
        contentPane.add(myList);
        
        
        JButton btnEditACourse = new JButton("View Enrolled Students");
		btnEditACourse.setFont(new Font("Futura", Font.PLAIN, 13));
		btnEditACourse.setBounds(200, 750, 179, 29);
    ...
    public void display(int courseId) {
        ...
        JFrame frame = new JFrame(course.getCourseName());
        ArrayList<Student> listofstudents = course.getEnrolledStudents();
		...
		JLabel lblAddACourse = new JLabel("Students Enrolled");
		lblAddACourse.setFont(new Font("Futura", Font.PLAIN, 30));
		lblAddACourse.setBounds(60, 57, 351, 43);
		contentPane.add(lblAddACourse);
        
        String[] data = new String[listofstudents.size()];
        for(int i = 0; i < listofstudents.size(); i++) {
            data[i] = listofstudents.get(i).toString();
        }
        
        JList<String> myList = new JList<String>(data);
        myList.setSelectionMode(DefaultListSelectionModel.SINGLE_SELECTION);
        myList.setBounds(60, 100, 400, 400);
        contentPane.add(myList);
