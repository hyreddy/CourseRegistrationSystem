/*
 * @Hrishikesh Yeluru
 * This class creates the variables and implements the methods used in the Admin class.
 */
...
public class Admin extends User implements AdminMethods, java.io.Serializable {
	...
	// Method that allows the admin the create a new course
	@Override
	...
	// Method takes in the Courses arraylist and name and section number of the course to delete it from the list
	@Override
	...
	// This method uses the name and section number to find a course
    @Override
 ...
 // This method uses the course id to find a course
    @Override
	...
	// Prints the courses to console with matching course id
	@Override
	...
	// Returns an arrayList with all the full courses
	@Override
	...
	public void writeFullToFile (ArrayList<Course> arr) {
		...
		try {
			FileWriter myWriter = new FileWriter("crsfullcourses.txt");
			if(full.size() >= 1) {
			for(Course c: full) {
			...
			myWriter.close();
			System.out.println("Successfully wrote to crsfullcourses.txt");
			} catch (IOException e) {
	...
	// Method that returns all the students in a course
	@Override
	...
	// Method returns the index of a student in the ArrayList
	@Override
	...
	// Method returns courses a student is enrolled in
	@Override
	...
	// Sorts the courses by registered number of students
	@Override
